...
function askQuestion(questionNumber) {
    ...
    switch (questionNumber) {
        ...
        case 2:
            ...
            break;
        case 3:
            question.innerHTML = "Continue to the Moon, or cancel the mission";
        default:
            break;
    }
...
function continueStory(answerNumber) {
    switch (answerNumber) {
        ...
        case 2:
            ...
            break;
        case 3:
            if (answers[3] === "CONTINUE TO THE MOON") {
                story.innerHTML = document.getElementById("answer30").innerHTML;
                theEnd();
            } else if (answers[3] === "CANCEL THE MISSION") {
